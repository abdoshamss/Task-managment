...
class TextStylesManager {
  ...
  static TextStyle gessRegular = const TextStyle(
    fontFamily: 'GESS',
    fontWeight: FontWeight.w400,
  );
  static TextStyle gessMedium = const TextStyle(
    fontFamily: 'GESS',
    fontWeight: FontWeight.w500,
  );
  static TextStyle gessSemiBold = const TextStyle(
    fontFamily: 'GESS',
    fontWeight: FontWeight.w600,
  );
  static TextStyle gessBold = const TextStyle(
    fontFamily: 'GESS',
    fontWeight: FontWeight.w700,
  );
  static TextStyle aristaRegular = const TextStyle(
    fontFamily: 'arista',
    fontWeight: FontWeight.w400,
  );
  static TextStyle aristaMedium = const TextStyle(
    fontFamily: 'arista',
    fontWeight: FontWeight.w500,
  );
  static TextStyle aristaSemiBold = const TextStyle(
    fontFamily: 'arista',
    fontWeight: FontWeight.w600,
  );
  static TextStyle aristaBold = const TextStyle(
    fontFamily: 'arista',
    fontWeight: FontWeight.w700,
  );
}
