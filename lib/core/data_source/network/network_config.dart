...
class RequestConfig {
  ...
  static const RequestConfig get = RequestConfig(enableCache: true);

  /// Default configuration for POST requests
  static const RequestConfig post = RequestConfig(loading: true);

  /// Default configuration for form submissions
  static const RequestConfig form = RequestConfig(loading: true, isForm: true);
